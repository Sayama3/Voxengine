...
if(spirv-cross-c IN_LIST Vulkan_FIND_COMPONENTS)
    find_library(Vulkan_spirv-cross-c_LIBRARY
            NAMES spirv-cross-c
            HINTS
            ${_Vulkan_hint_library_search_paths})
    mark_as_advanced(Vulkan_spirv-cross-c_LIBRARY)

    find_library(Vulkan_spirv-cross-c_DEBUG_LIBRARY
            NAMES spirv-cross-cd
            HINTS
            ${_Vulkan_hint_library_search_paths})
    mark_as_advanced(Vulkan_spirv-cross-c_DEBUG_LIBRARY)
endif()

if(spirv-cross-core IN_LIST Vulkan_FIND_COMPONENTS)
    find_library(Vulkan_spirv-cross-core_LIBRARY
            NAMES spirv-cross-core
            HINTS
            ${_Vulkan_hint_library_search_paths})
    mark_as_advanced(Vulkan_spirv-cross-core_LIBRARY)

    find_library(Vulkan_spirv-cross-core_DEBUG_LIBRARY
            NAMES spirv-cross-cored
            HINTS
            ${_Vulkan_hint_library_search_paths})
    mark_as_advanced(Vulkan_spirv-cross-core_DEBUG_LIBRARY)
endif()

if(spirv-cross-cpp IN_LIST Vulkan_FIND_COMPONENTS)
    find_library(Vulkan_spirv-cross-cpp_LIBRARY
            NAMES spirv-cross-cpp
            HINTS
            ${_Vulkan_hint_library_search_paths})
    mark_as_advanced(Vulkan_spirv-cross-cpp_LIBRARY)

    find_library(Vulkan_spirv-cross-cpp_DEBUG_LIBRARY
            NAMES spirv-cross-cppd
            HINTS
            ${_Vulkan_hint_library_search_paths})
    mark_as_advanced(Vulkan_spirv-cross-cpp_DEBUG_LIBRARY)
endif()

if(spirv-cross-c-shared IN_LIST Vulkan_FIND_COMPONENTS)
    find_library(Vulkan_spirv-cross-c-shared_LIBRARY
            NAMES spirv-cross-c-shared
            HINTS
            ${_Vulkan_hint_library_search_paths})
    mark_as_advanced(Vulkan_spirv-cross-c-shared_LIBRARY)

    find_library(Vulkan_spirv-cross-c-shared_DEBUG_LIBRARY
            NAMES spirv-cross-c-sharedd
            HINTS
            ${_Vulkan_hint_library_search_paths})
    mark_as_advanced(Vulkan_spirv-cross-c-shared_DEBUG_LIBRARY)
endif()

if(spirv-cross-glsl IN_LIST Vulkan_FIND_COMPONENTS)
    find_library(Vulkan_spirv-cross-glsl_LIBRARY
            NAMES spirv-cross-glsl
            HINTS
            ${_Vulkan_hint_library_search_paths})
    mark_as_advanced(Vulkan_spirv-cross-glsl_LIBRARY)

    find_library(Vulkan_spirv-cross-glsl_DEBUG_LIBRARY
            NAMES spirv-cross-glsld
            HINTS
            ${_Vulkan_hint_library_search_paths})
    mark_as_advanced(Vulkan_spirv-cross-glsl_DEBUG_LIBRARY)
endif()

if(spirv-cross-hlsl IN_LIST Vulkan_FIND_COMPONENTS)
    find_library(Vulkan_spirv-cross-hlsl_LIBRARY
            NAMES spirv-cross-hlsl
            HINTS
            ${_Vulkan_hint_library_search_paths})
    mark_as_advanced(Vulkan_spirv-cross-hlsl_LIBRARY)

    find_library(Vulkan_spirv-cross-hlsl_DEBUG_LIBRARY
            NAMES spirv-cross-hlsld
            HINTS
            ${_Vulkan_hint_library_search_paths})
    mark_as_advanced(Vulkan_spirv-cross-hlsl_DEBUG_LIBRARY)
endif()

if(spirv-cross-msl IN_LIST Vulkan_FIND_COMPONENTS)
    find_library(Vulkan_spirv-cross-msl_LIBRARY
            NAMES spirv-cross-msl
            HINTS
            ${_Vulkan_hint_library_search_paths})
    mark_as_advanced(Vulkan_spirv-cross-msl_LIBRARY)

    find_library(Vulkan_spirv-cross-msl_DEBUG_LIBRARY
            NAMES spirv-cross-msld
            HINTS
            ${_Vulkan_hint_library_search_paths})
    mark_as_advanced(Vulkan_spirv-cross-msl_DEBUG_LIBRARY)
endif()

if(spirv-cross-reflect IN_LIST Vulkan_FIND_COMPONENTS)
    find_library(Vulkan_spirv-cross-reflect_LIBRARY
            NAMES spirv-cross-reflect
            HINTS
            ${_Vulkan_hint_library_search_paths})
    mark_as_advanced(Vulkan_spirv-cross-reflect_LIBRARY)

    find_library(Vulkan_spirv-cross-reflect_DEBUG_LIBRARY
            NAMES spirv-cross-reflectd
            HINTS
            ${_Vulkan_hint_library_search_paths})
    mark_as_advanced(Vulkan_spirv-cross-reflect_DEBUG_LIBRARY)
endif()

if(spirv-cross-util IN_LIST Vulkan_FIND_COMPONENTS)
    find_library(Vulkan_spirv-cross-util_LIBRARY
            NAMES spirv-cross-util
            HINTS
            ${_Vulkan_hint_library_search_paths})
    mark_as_advanced(Vulkan_spirv-cross-util_LIBRARY)

    find_library(Vulkan_spirv-cross-util_DEBUG_LIBRARY
            NAMES spirv-cross-utild
            HINTS
            ${_Vulkan_hint_library_search_paths})
    mark_as_advanced(Vulkan_spirv-cross-util_DEBUG_LIBRARY)
endif()
...
_Vulkan_set_library_component_found(spirv-cross-c)
_Vulkan_set_library_component_found(spirv-cross-core)
_Vulkan_set_library_component_found(spirv-cross-cpp)
_Vulkan_set_library_component_found(spirv-cross-c-shared)
_Vulkan_set_library_component_found(spirv-cross-glsl)
_Vulkan_set_library_component_found(spirv-cross-hlsl)
_Vulkan_set_library_component_found(spirv-cross-msl)
_Vulkan_set_library_component_found(spirv-cross-reflect)
_Vulkan_set_library_component_found(spirv-cross-util)
...
if(Vulkan_INCLUDE_DIR)
    ...
    if(EXISTS ${VULKAN_CORE_H})
        ...
        list(JOIN VulkanHeaderVersion2 "../../lib/vulkan" Vulkan_VERSION)
    endif()
endif()
...
if(Vulkan_FOUND)
    ...
    if((Vulkan_spirv-cross-c_LIBRARY OR Vulkan_spirv-cross-c_DEBUG_LIBRARY) AND NOT TARGET Vulkan::SPIRV-Cross-C)
        add_library(Vulkan::SPIRV-Cross-C STATIC IMPORTED)
        set_property(TARGET Vulkan::SPIRV-Cross-C
                PROPERTY
                INTERFACE_INCLUDE_DIRECTORIES "${Vulkan_INCLUDE_DIRS}")
        if(Vulkan_spirv-cross-c_LIBRARY)
            set_property(TARGET Vulkan::SPIRV-Cross-C APPEND
                    PROPERTY
                    IMPORTED_CONFIGURATIONS Release)
            set_property(TARGET Vulkan::SPIRV-Cross-C
                    PROPERTY
                    IMPORTED_LOCATION_RELEASE "${Vulkan_spirv-cross-c_LIBRARY}")
        endif()
        if(Vulkan_spirv-cross-c_DEBUG_LIBRARY)
            set_property(TARGET Vulkan::SPIRV-Cross-C APPEND
                    PROPERTY
                    IMPORTED_CONFIGURATIONS Debug)
            set_property(TARGET Vulkan::SPIRV-Cross-C
                    PROPERTY
                    IMPORTED_LOCATION_DEBUG "${Vulkan_spirv-cross-c_DEBUG_LIBRARY}")
        endif()
    endif()

    if((Vulkan_spirv-cross-core_LIBRARY OR Vulkan_spirv-cross-core_DEBUG_LIBRARY) AND NOT TARGET Vulkan::SPIRV-Cross-Core)
        add_library(Vulkan::SPIRV-Cross-Core STATIC IMPORTED)
        set_property(TARGET Vulkan::SPIRV-Cross-Core
                PROPERTY
                INTERFACE_INCLUDE_DIRECTORIES "${Vulkan_INCLUDE_DIRS}")
        if(Vulkan_spirv-cross-core_LIBRARY)
            set_property(TARGET Vulkan::SPIRV-Cross-Core APPEND
                    PROPERTY
                    IMPORTED_CONFIGURATIONS Release)
            set_property(TARGET Vulkan::SPIRV-Cross-Core
                    PROPERTY
                    IMPORTED_LOCATION_RELEASE "${Vulkan_spirv-cross-core_LIBRARY}")
        endif()
        if(Vulkan_spirv-cross-core_DEBUG_LIBRARY)
            set_property(TARGET Vulkan::SPIRV-Cross-Core APPEND
                    PROPERTY
                    IMPORTED_CONFIGURATIONS Debug)
            set_property(TARGET Vulkan::SPIRV-Cross-Core
                    PROPERTY
                    IMPORTED_LOCATION_DEBUG "${Vulkan_spirv-cross-core_DEBUG_LIBRARY}")
        endif()
    endif()

    if((Vulkan_spirv-cross-cpp_LIBRARY OR Vulkan_spirv-cross-cpp_DEBUG_LIBRARY) AND NOT TARGET Vulkan::SPIRV-Cross-CPP)
        add_library(Vulkan::SPIRV-Cross-CPP STATIC IMPORTED)
        set_property(TARGET Vulkan::SPIRV-Cross-CPP
                PROPERTY
                INTERFACE_INCLUDE_DIRECTORIES "${Vulkan_INCLUDE_DIRS}")
        if(Vulkan_spirv-cross-cpp_LIBRARY)
            set_property(TARGET Vulkan::SPIRV-Cross-CPP APPEND
                    PROPERTY
                    IMPORTED_CONFIGURATIONS Release)
            set_property(TARGET Vulkan::SPIRV-Cross-CPP
                    PROPERTY
                    IMPORTED_LOCATION_RELEASE "${Vulkan_spirv-cross-cpp_LIBRARY}")
        endif()
        if(Vulkan_spirv-cross-cpp_DEBUG_LIBRARY)
            set_property(TARGET Vulkan::SPIRV-Cross-CPP APPEND
                    PROPERTY
                    IMPORTED_CONFIGURATIONS Debug)
            set_property(TARGET Vulkan::SPIRV-Cross-CPP
                    PROPERTY
                    IMPORTED_LOCATION_DEBUG "${Vulkan_spirv-cross-cpp_DEBUG_LIBRARY}")
        endif()
    endif()

    if((Vulkan_spirv-cross-c-shared_LIBRARY OR Vulkan_spirv-cross-c-shared_DEBUG_LIBRARY) AND NOT TARGET Vulkan::SPIRV-Cross-C-Shared)
        add_library(Vulkan::SPIRV-Cross-C-Shared SHARED IMPORTED)
        set_property(TARGET Vulkan::SPIRV-Cross-C-Shared
                PROPERTY
                INTERFACE_INCLUDE_DIRECTORIES "${Vulkan_INCLUDE_DIRS}")
        if(Vulkan_spirv-cross-c-shared_LIBRARY)
            set_property(TARGET Vulkan::SPIRV-Cross-C-Shared APPEND
                    PROPERTY
                    IMPORTED_CONFIGURATIONS Release)
            set_property(TARGET Vulkan::SPIRV-Cross-C-Shared
                    PROPERTY
                    IMPORTED_LOCATION_RELEASE "${Vulkan_spirv-cross-c-shared_LIBRARY}")
        endif()
        if(Vulkan_spirv-cross-c-shared_DEBUG_LIBRARY)
            set_property(TARGET Vulkan::SPIRV-Cross-C-Shared APPEND
                    PROPERTY
                    IMPORTED_CONFIGURATIONS Debug)
            set_property(TARGET Vulkan::SPIRV-Cross-C-Shared
                    PROPERTY
                    IMPORTED_LOCATION_DEBUG "${Vulkan_spirv-cross-c-shared_DEBUG_LIBRARY}")
        endif()
    endif()

    if((Vulkan_spirv-cross-glsl_LIBRARY OR Vulkan_spirv-cross-glsl_DEBUG_LIBRARY) AND NOT TARGET Vulkan::SPIRV-Cross-GLSL)
        add_library(Vulkan::SPIRV-Cross-GLSL STATIC IMPORTED)
        set_property(TARGET Vulkan::SPIRV-Cross-GLSL
                PROPERTY
                INTERFACE_INCLUDE_DIRECTORIES "${Vulkan_INCLUDE_DIRS}")
        if(Vulkan_spirv-cross-glsl_LIBRARY)
            set_property(TARGET Vulkan::SPIRV-Cross-GLSL APPEND
                    PROPERTY
                    IMPORTED_CONFIGURATIONS Release)
            set_property(TARGET Vulkan::SPIRV-Cross-GLSL
                    PROPERTY
                    IMPORTED_LOCATION_RELEASE "${Vulkan_spirv-cross-glsl_LIBRARY}")
        endif()
        if(Vulkan_spirv-cross-glsl_DEBUG_LIBRARY)
            set_property(TARGET Vulkan::SPIRV-Cross-GLSL APPEND
                    PROPERTY
                    IMPORTED_CONFIGURATIONS Debug)
            set_property(TARGET Vulkan::SPIRV-Cross-GLSL
                    PROPERTY
                    IMPORTED_LOCATION_DEBUG "${Vulkan_spirv-cross-glsl_DEBUG_LIBRARY}")
        endif()
    endif()

    if((Vulkan_spirv-cross-hlsl_LIBRARY OR Vulkan_spirv-cross-hlsl_DEBUG_LIBRARY) AND NOT TARGET Vulkan::SPIRV-Cross-HLSL)
        add_library(Vulkan::SPIRV-Cross-HLSL STATIC IMPORTED)
        set_property(TARGET Vulkan::SPIRV-Cross-HLSL
                PROPERTY
                INTERFACE_INCLUDE_DIRECTORIES "${Vulkan_INCLUDE_DIRS}")
        if(Vulkan_spirv-cross-hlsl_LIBRARY)
            set_property(TARGET Vulkan::SPIRV-Cross-HLSL APPEND
                    PROPERTY
                    IMPORTED_CONFIGURATIONS Release)
            set_property(TARGET Vulkan::SPIRV-Cross-HLSL
                    PROPERTY
                    IMPORTED_LOCATION_RELEASE "${Vulkan_spirv-cross-hlsl_LIBRARY}")
        endif()
        if(Vulkan_spirv-cross-hlsl_DEBUG_LIBRARY)
            set_property(TARGET Vulkan::SPIRV-Cross-HLSL APPEND
                    PROPERTY
                    IMPORTED_CONFIGURATIONS Debug)
            set_property(TARGET Vulkan::SPIRV-Cross-HLSL
                    PROPERTY
                    IMPORTED_LOCATION_DEBUG "${Vulkan_spirv-cross-hlsl_DEBUG_LIBRARY}")
        endif()
    endif()

    if((Vulkan_spirv-cross-msl_LIBRARY OR Vulkan_spirv-cross-msl_DEBUG_LIBRARY) AND NOT TARGET Vulkan::SPIRV-Cross-MSL)
        add_library(Vulkan::SPIRV-Cross-MSL STATIC IMPORTED)
        set_property(TARGET Vulkan::SPIRV-Cross-MSL
                PROPERTY
                INTERFACE_INCLUDE_DIRECTORIES "${Vulkan_INCLUDE_DIRS}")
        if(Vulkan_spirv-cross-msl_LIBRARY)
            set_property(TARGET Vulkan::SPIRV-Cross-MSL APPEND
                    PROPERTY
                    IMPORTED_CONFIGURATIONS Release)
            set_property(TARGET Vulkan::SPIRV-Cross-MSL
                    PROPERTY
                    IMPORTED_LOCATION_RELEASE "${Vulkan_spirv-cross-msl_LIBRARY}")
        endif()
        if(Vulkan_spirv-cross-msl_DEBUG_LIBRARY)
            set_property(TARGET Vulkan::SPIRV-Cross-MSL APPEND
                    PROPERTY
                    IMPORTED_CONFIGURATIONS Debug)
            set_property(TARGET Vulkan::SPIRV-Cross-MSL
                    PROPERTY
                    IMPORTED_LOCATION_DEBUG "${Vulkan_spirv-cross-msl_DEBUG_LIBRARY}")
        endif()
    endif()

    if((Vulkan_spirv-cross-reflect_LIBRARY OR Vulkan_spirv-cross-reflect_DEBUG_LIBRARY) AND NOT TARGET Vulkan::SPIRV-Cross-Reflect)
        add_library(Vulkan::SPIRV-Cross-Reflect STATIC IMPORTED)
        set_property(TARGET Vulkan::SPIRV-Cross-Reflect
                PROPERTY
                INTERFACE_INCLUDE_DIRECTORIES "${Vulkan_INCLUDE_DIRS}")
        if(Vulkan_spirv-cross-reflect_LIBRARY)
            set_property(TARGET Vulkan::SPIRV-Cross-Reflect APPEND
                    PROPERTY
                    IMPORTED_CONFIGURATIONS Release)
            set_property(TARGET Vulkan::SPIRV-Cross-Reflect
                    PROPERTY
                    IMPORTED_LOCATION_RELEASE "${Vulkan_spirv-cross-reflect_LIBRARY}")
        endif()
        if(Vulkan_spirv-cross-reflect_DEBUG_LIBRARY)
            set_property(TARGET Vulkan::SPIRV-Cross-Reflect APPEND
                    PROPERTY
                    IMPORTED_CONFIGURATIONS Debug)
            set_property(TARGET Vulkan::SPIRV-Cross-Reflect
                    PROPERTY
                    IMPORTED_LOCATION_DEBUG "${Vulkan_spirv-cross-reflect_DEBUG_LIBRARY}")
        endif()
    endif()

    if((Vulkan_spirv-cross-util_LIBRARY OR Vulkan_spirv-cross-util_DEBUG_LIBRARY) AND NOT TARGET Vulkan::SPIRV-Cross-Util)
        add_library(Vulkan::SPIRV-Cross-Util STATIC IMPORTED)
        set_property(TARGET Vulkan::SPIRV-Cross-Util
                PROPERTY
                INTERFACE_INCLUDE_DIRECTORIES "${Vulkan_INCLUDE_DIRS}")
        if(Vulkan_spirv-cross-util_LIBRARY)
            set_property(TARGET Vulkan::SPIRV-Cross-Util APPEND
                    PROPERTY
                    IMPORTED_CONFIGURATIONS Release)
            set_property(TARGET Vulkan::SPIRV-Cross-Util
                    PROPERTY
                    IMPORTED_LOCATION_RELEASE "${Vulkan_spirv-cross-util_LIBRARY}")
        endif()
        if(Vulkan_spirv-cross-util_DEBUG_LIBRARY)
            set_property(TARGET Vulkan::SPIRV-Cross-Util APPEND
                    PROPERTY
                    IMPORTED_CONFIGURATIONS Debug)
            set_property(TARGET Vulkan::SPIRV-Cross-Util
                    PROPERTY
                    IMPORTED_LOCATION_DEBUG "${Vulkan_spirv-cross-util_DEBUG_LIBRARY}")
        endif()
    endif()
